...
(1, 'kaikaigarvill@gmail.com', '09913379901', 'Chanchan', '1818', '2025-01-26 13:34:23.000000'),
...
CREATE TABLE `user_details` (
  ...
  `bday` date NOT NULL,
  `img` varchar(250) NOT NULL DEFAULT '../assets/img/person-1.jpg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `user_details` (`id`, `user_id`, `first_name`, `last_name`, `bday`, `img`) VALUES
(1, 1, 'Christian Paul', 'Villanueva', '2002-09-04', '../assets/img/person-1.jpg'),
(2, 2, 'Vincent', 'Manalang', '2001-06-21', '../assets/img/person-2.jpg');
